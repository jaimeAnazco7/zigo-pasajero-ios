...
Future<Response> buildHttpResponse(String endPoint, {HttpMethod method = HttpMethod.GET, Map? request, Map<String, String>? header_extra}) async {
  if (await isNetworkAvailable()) {
    ...
    try {
      ...
      if (err.contains('Failed host lookup') || err.contains('SocketException') || err.contains('ClientException')) {
        throw 'No se pudo conectar con el servidor. Revisa internet, DNS o que ${url.host} sea accesible desde el teléfono.';
      }
