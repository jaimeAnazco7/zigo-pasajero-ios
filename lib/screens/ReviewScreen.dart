...
class ReviewScreenState extends State<ReviewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(language.driverReview, style: boldTextStyle(color: neonHighlight)),
        actions: [
          Padding(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('${language.howWasYourRide}', style: boldTextStyle(color: Colors.white)),
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          // SizedBox(height: 8),
                          Text('${widget.driverData!.firstName.validate().capitalizeFirstLetter()} ${widget.driverData!.lastName.validate().capitalizeFirstLetter()}', style: boldTextStyle(color: neonHighlight)),
                          // SizedBox(height: 4),
                          Text('${widget.driverData!.email.validate()}', style: primaryTextStyle(color: zigoOrange)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  RatingBar.builder(
                    ...
                    itemBuilder: (context, index) {
                      final isSelected = index < rattingData;
                      return Stack(
                        alignment: Alignment.center,
                        children: [
                          Icon(Icons.star, color: Colors.white, size: 28),
                          Icon(Icons.star, color: isSelected ? Colors.amber : Colors.grey, size: 22),
                        ],
                      );
                    },
                  ...
                  SizedBox(height: 16),
                  Text(language.addReviews, style: boldTextStyle(color: Colors.white)),
                  SizedBox(height: 16),
                  AppTextField(
                    controller: reviewController,
                    isValidationRequired: false,
                    textStyle: primaryTextStyle(color: Colors.white),
                    decoration: inputDecoration(context, label: language.writeYourComments).copyWith(
                      labelStyle: primaryTextStyle(color: zigoOrange),
                      hintStyle: primaryTextStyle(color: zigoOrange),
                    ),
