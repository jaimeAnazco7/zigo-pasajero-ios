  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(language.bankInfo, style: boldTextStyle(color: neonHighlight)),
      ),
      body: Form(
        key: formKey,
        child: Stack(
              ...
              child: Column(
                children: [
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, label: language.bankName).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, label: language.bankCode).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    textFieldType: TextFieldType.NAME,
                    errorThisFieldRequired: language.thisFieldRequired,
                    decoration: inputDecoration(context, label: language.accountHolderName).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    errorThisFieldRequired: language.thisFieldRequired,
                    decoration: inputDecoration(context, label: language.accountNumber).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    // errorThisFieldRequired: language.thisFieldRequired,
                    decoration: inputDecoration(context, label: language.routingNumber).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    textFieldType: TextFieldType.OTHER,
                    // errorThisFieldRequired: language.thisFieldRequired,
                    decoration: inputDecoration(context, label: language.iban).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    textFieldType: TextFieldType.OTHER,
                    // errorThisFieldRequired: language.thisFieldRequired,
                    decoration: inputDecoration(context, label: language.swift).copyWith(labelStyle: primaryTextStyle(color: zigoOrangeLight), hintStyle: primaryTextStyle(color: zigoOrangeLight)),
                  ),
                ],
              ),
            ),
