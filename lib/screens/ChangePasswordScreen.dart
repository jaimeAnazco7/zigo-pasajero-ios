...
class ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(language.changePassword, style: boldTextStyle(color: neonHighlight)),
      ),
      body: Stack(
        children: [
          Form(
              ...
              child: Column(
                ...
                children: [
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, label: language.oldPassword).copyWith(
                      labelStyle: primaryTextStyle(color: zigoOrangeLight),
                      hintStyle: primaryTextStyle(color: zigoOrangeLight),
                    ),
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, label: language.newPassword).copyWith(
                      labelStyle: primaryTextStyle(color: zigoOrangeLight),
                      hintStyle: primaryTextStyle(color: zigoOrangeLight),
                    ),
                    errorThisFieldRequired: language.thisFieldRequired,
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, label: language.confirmPassword).copyWith(
                      labelStyle: primaryTextStyle(color: zigoOrangeLight),
                      hintStyle: primaryTextStyle(color: zigoOrangeLight),
                    ),
                    errorThisFieldRequired: language.thisFieldRequired,
