...
class BaseLanguage {
  ...
  String get bookNow => 'Solicitar Ahora';
  ...
  /// Mismo modal de búsqueda de conductor al vencer el tiempo (texto fijo ES — Zigo).
  String get driverSearchTimeoutMessage =>
      'No encontramos conductores disponibles. Puedes seguir buscando o cancelar el viaje.';

  String get keepSearchingDrivers => 'Seguir buscando';
  ...
  String get shareRide => getContentValueFromKey(395);
}
